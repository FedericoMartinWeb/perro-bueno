...
<body>
    ...
    <!-- <picture>
        ...
        <div class="large-hero__img-wrapper">
            <img src="assets/images/perro_56_2.png" alt="" class="large-hero__image">
        </div>
    ...
    <section class="gallery page-section" id="gallery">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="gallery__item col-md-6 col-lg-4 gallery-reveal">
                    <a href="assets/images/perro_5.jpg" data-lightbox="image-1" data-title="My caption"><img src="assets/images/perro_5.jpg" alt=""></a>
                </div>
                <div class="gallery__item col-md-6 col-lg-4 gallery-reveal">
